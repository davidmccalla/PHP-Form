...
<div class="section page">
  ...
  <div class="wrapper">
    ...
    <div class="breadcrumbs">
      ...
      &gt; <a href="cata;pg.php?cat=<?php echo strtolower($item["category"]); ?>">
  ...
  <div class="media-details">
      ...
      <table>
        ...
        <tr>
          <th>Publisher</th>
          <td><?php echo $items["publisher"]; ?></td>
        </tr>
        <tr>
          <th>ISBN</th>
          <td><?php echo $items["isbn"]; ?></td>
        </tr>
      <?php } else if (strtolower($item["category"]) == "movies") { ?>
        <tr>
          <th>Director</th>
          <td><?php echo $items["director"]; ?></td>
        </tr>
        <tr>
          <th>Writers</th>
